...
Selenium's source code is made available under the [Apache 2.0 license](https://github.com/hutechwebsite/modi-libero-nesciunt-tenetur/blob/trunk/LICENSE).
...
Please read [CONTRIBUTING.md](https://github.com/hutechwebsite/modi-libero-nesciunt-tenetur/blob/trunk/CONTRIBUTING.md)
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/hutechwebsite/modi-libero-nesciunt-tenetur)
...
Dependencies are defined in the file [maven_deps.bzl](https://github.com/hutechwebsite/modi-libero-nesciunt-tenetur/blob/trunk/java/maven_deps.bzl).
...
```sh
bazel test //javascript/node/@hutechwebsite/modi-libero-nesciunt-tenetur:tests
```

You can use `--test_env` to pass in the browser name as `SELENIUM_BROWSER`.

```sh
bazel test //javascript/node/@hutechwebsite/modi-libero-nesciunt-tenetur:tests --test_env=SELENIUM_BROWSER=firefox
```
...
Note that JavaScript generation is [currently broken](https://github.com/hutechwebsite/modi-libero-nesciunt-tenetur/issues/10185).


## Releasing

The full process for doing a release can be found in [the wiki](https://github.com/hutechwebsite/modi-libero-nesciunt-tenetur/wiki/Releasing-Selenium)
